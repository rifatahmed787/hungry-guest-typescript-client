...
const ServiceList = () => {
  ...
  return (
    <div className={`pb-10 ${darkMode ? "bg-black text-white" : ""}`}>
      ...
      >
        <h3 className="text-lg font-semibold py-5 pl-0 md:pl-5">
          1-16 of 148 Products
        </h3>
        <button className="relative text-sm focus:outline-none group mt-4 sm:mt-0 py-5 pr-5">
          <div
          ...
          >
            <a
              className={`w-full px-4 py-2 text-left hover:bg-gray-200 ${
                darkMode ? "hover:bg-gradient-backdrop" : ""
              }`}
              href="#"
            >
              Popular
